...
import { DTMF_LOW_FREQUENCIES, DTMF_HIGH_FREQUENCIES, DTMF_FREQUENCY_TO_CODE } from './constants.js';
...
export default class DTMFDetector {
  ...
  private readonly _lowFreqs = [...DTMF_LOW_FREQUENCIES];
  private readonly _highFreqs = [...DTMF_HIGH_FREQUENCIES];
  private readonly _codeMap = { ...DTMF_FREQUENCY_TO_CODE };
